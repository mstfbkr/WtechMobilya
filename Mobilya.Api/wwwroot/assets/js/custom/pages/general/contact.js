    ...
    return {
        init: function () {
            o = document.querySelector("#kt_contact_form"),
                ...
                $(o.querySelector('[name="position"]')).on("change",
                    (function () { e.revalidateField("position") })),
                            ...
                            o.preventDefault(),
                                e && e.validate().then((function (e) {
                                    console.log("validated!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"),
                                        ...
                                        }).then((function (t) { KTUtil.scrollTop() }))
                                }))
                        })), function (t) {
                            if (L) {
                                var e,
                                    o = L.map(t,
                                        {
                                            center: [40.725, -73.985], zoom: 30
                                        });
                                L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",
                                    { attribution: '&copy; <a href="https://osm.org/copyright">OpenStreetMap</a> contributors' }).addTo(o),
                                ...
                                var i = L.layerGroup().addTo(o),
                                    r = L.divIcon({
                                        ...
                                        { icon: r }).addTo(i).bindPopup("430 E 6th St, New York, 10009.",
                                            {
                                                closeButton: !1
                                            }).openPopup(), o.on("click",
                                                (function (t) {
                                                    e.reverse().latlng(t.latlng).run((function (t, e) {
                                                        t || (i.clearLayers(), n = e.address.Match_addr, L.marker(e.latlng, { icon: r }).addTo(i).bindPopup(e.address.Match_addr,
                                                            { closeButton: !1 }).openPopup(),
                                                            Swal.fire({
...
}(); KTUtil.onDOMContentLoaded((function () { KTContactApply.init() }));