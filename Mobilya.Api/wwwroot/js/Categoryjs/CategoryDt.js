...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_example_1").DataTable({
            ...
            ajax: {
                url: "https://localhost:44375/api/category/GetAlldt",
                type: "POST",
                        ...
                        return `<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-customer-table-filter="edit_row" id="edit">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    var handleEditRowDatatable = () => {
        ...
        editButton.forEach(f => {
            ...
            f.addEventListener('click', function (e) {
                ...
                var CategoryId = parent.querySelectorAll('td')[1].innerText;
                var CategoryName = parent.querySelectorAll('td')[2].innerText;
                var CategoryMain = parent.querySelectorAll('td')[3].innerText;
                
                
                console.log(CategoryId);
                $("[name='categoryid']").val(CategoryId);
                $("[name='categoryname']").val(CategoryName);
                $("[name='categorymain']").val(CategoryMain);
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: categoryName + " Kaydını silmek istediğinizden emin misiniz ?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",                           
                            url: "https://localhost:44375/api/Category/Delete/" + id,
    ...
    var initToggleToolbar = function () {
        ...
        deleteSelected.addEventListener('click', function () {
            // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
            Swal.fire({
                text: "Bu kategori silinecek emin misiniz?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
